...
|              사용 방법               |
| :----------------------------------: |
| <img src="./asset/img/howto.gif"  /> |

- 사용자는 메인 서비스를 이용하기 전 사용방법을 확인할 수 있습니다.
...
- 이때 사용자가 요청 버튼을 클릭하면 요청한 내용들은 로컬스토리지에 저장됩니다.

- AI의 응답이 완료되면 응답 받은 내용을 html 문서에 출력합니다. 이때 출력한 내용 또한 로컬스토리지에 저장됩니다.
...
- 위 통계는 사용자가 AI에게 요청할 때 저장된 로컬스토리지를 통해 나타난 수치입니다.
...
- 위 기록 또한 사용자가 AI에게 요청할 때 입력한 내용과 AI가 답변할 때 로컬스토리지에 저장된 내용을 기반으로 사용자들에게 보여집니다.

- 기록을 삭제하고 싶다면 기록삭제 버튼을 클릭하여 로컬스토리지에 저장된 모든 데이터들을 삭제 시킬 수 있습니다.
